...
{/* <div class="animate-[wiggle_1s_ease-in-out_infinite] ..."></div> */}
    ...
    return(
            ...
            <section className="flex flex-col md:gap-0 gap-10 p-4 md:grid md:grid-cols-2 items-center place-items-center w-[99%] md:w-[60%] h-fit mb-10 border-color rounded-r-2xl border-l-0 border-6 moveRight bg-[#121212]/50 ">
                <h2 className='col-span-2 text-white text-3xl md:text-4xl title-color font-extrabold'>Tecnologias utilizadas</h2>
