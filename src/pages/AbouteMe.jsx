  ...
  return (
    <article className="w-[99%] md:w-[70%] h-fit md:h-[80%] border-6 border-l-0 border-color rounded-r-2xl flex flex-col md:flex-row gap-4 moveRight bg-[#121212]/50  ">
      ...
      <div className="text-white flex justify-center mt-4 mb-4 md:mt-[10%] relative ">
        ...
        <h1>
          <span className="text-color md:text-3xl efecto1 md:left-[60px] left-[95px] text-[28px] font-extrabold absolute "> 
            Adrian
          </span>
          <span className="text-color md:text-3xl efecto2 md:left-[185px] hidden md:flex  left-[140px] text-[28px] font-extrabold   absolute"> 
            Alexis
          </span>
          <span className="text-color md:text-3xl efecto3 md:left-[310px] left-[200px]  text-[28px] font-extrabold  absolute">
            Lopez
          </span>
        ...
        <IconSlash stroke={3} size={40} className="absolute md:left-134 left-[280px] aparecer title-color" />
        <IconChevronRight stroke={3} size={40} className="absolute md:left-140 left-[300px]  aparecer title-color" />
      </div>
