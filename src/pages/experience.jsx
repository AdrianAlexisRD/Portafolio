...
export const Experience = ({scroll}) =>{
    ...
    return(
        <section className={` 
            ...
            `}>
            <h2 className='md:text-4xl text-3xl title-color col-span-2 text-center font-extrabold'>Experiencia Laboral</h2>

  <div className="flex md:gap-7 gap-2 items-center md:justify-start border-color p-5 rounded rounded-l-full bg-[#121212]/50 sm:w-[90%] xl:w-[100%] xl:h-50">
  ...
  <div className="flex md:flex-row flex-row-reverse md:gap-7 gap-2 items-center m-0 border-color p-5 rounded xl:rounded-l-full rounded-r-full xl:rounded-r xl:text-start text-end  bg-[#121212]/50 sm:w-[90%] xl:w-[100%] xl:h-50">
  ...
  <div className="flex md:flex-row flex-row-reverse md:gap-7 gap-2 items-center m-0 xl:text-start text-end border-color p-5 rounded xl:rounded-l-full rounded-r-full xl:rounded-r bg-[#121212]/50 sm:w-[90%] xl:w-[100%] xl:h-50">
